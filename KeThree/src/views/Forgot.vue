<template>
  <div class="login">
    ...
    <div class="enterShop" @click="goState('Home')">
      先逛一逛
    </div>
    ...
    <div class="user-box">
      <div class="user-title">
        <div class="welcome clearfix">
          ...
          <span class="logo-name fl">找回密码</span>
          
        </div>
        <div class="sub-title">Find Your Password</div>
      </div>
      ...
      <van-form v-show="!isNext">
        ...
        >
           <template #button>
            <van-button size="small" color="#3a48bf" :disabled="isSend" @click="getValidCode">{{text}}</van-button>
          </template>
        </van-field>
        <div class="forgot">
        ...
        <div class="commit-btn">
          <van-button @click="next" round block color="#3a48bf">
            下一步
          </van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#3a48bf" @click="commit">
            提交
          </van-button>
        </div>
        <div class="commit-btn">
