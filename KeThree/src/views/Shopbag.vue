  ...
  <div class="shopbag">
    ...
    <div v-if="shopbagData.length == 0">
      <van-empty description="购物袋空空如也，去逛一逛!">
        <van-button round color="#3a48bf" class="bottom-button" @click="goShop">
          逛一逛
        </van-button>
      </van-empty>
    </div>
    <div class="shopbag-box" v-else>
      ...
      <van-submit-bar
        ...
        @submit="commit"
      >
        <van-checkbox v-model="isAllChecked" @click="allSelect" checked-color="#3a48bf"
          >全选</van-checkbox
        >
      </van-submit-bar>
      ...
      >
        <van-checkbox v-model="isAllChecked" @click="allSelect" checked-color="#EE0A24"
          >全选</van-checkbox
        >
      </van-submit-bar>
    </div>
