  ...
  <div class="pay">
    ...
    <div class="pay-box">
      ...
      <div class="order-info">
        <OrderList info-title-left="订单信息" :count="productInfo.count" :date="productInfo.date | formatDate('yyyy-MM-dd hh:mm:ss')" :total="productInfo.total">
    ...
    <div class="btn-box">
      <van-button type="primary" block round color="#3a48bf" @click="payBox">立即结算</van-button
      >
    </div>
